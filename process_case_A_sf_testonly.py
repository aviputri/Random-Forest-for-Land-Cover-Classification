...
ndwi_09_t = functions.extract_values(shp = file_train09_shp, raster = ndwi_09)
mndwi1_09_t = functions.extract_values(shp = file_train09_shp, raster = mndwi1_09)
mndwi2_09_t = functions.extract_values(shp = file_train09_shp, raster = mndwi2_09)
ndbi_09_t = functions.extract_values(shp = file_train09_shp, raster = ndbi_09)
mndbi_09_t = functions.extract_values(shp = file_train09_shp, raster = mndbi_09)
...
ndwi_11_t = functions.extract_values(shp = file_train11_shp, raster = ndwi_11)
mndwi1_11_t = functions.extract_values(shp = file_train11_shp, raster = mndwi1_11)
mndwi2_11_t = functions.extract_values(shp = file_train11_shp, raster = mndwi2_11)
ndbi_11_t = functions.extract_values(shp = file_train11_shp, raster = ndbi_11)
mndbi_11_t = functions.extract_values(shp = file_train11_shp, raster = mndbi_11)
