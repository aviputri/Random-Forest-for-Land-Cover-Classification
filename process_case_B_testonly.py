...
#Case B: n(sample points) == 1% * n(raster pixels)
...
train_array_09 = functions.combine_bands(b1 = b1_09_ar, b2 = b2_09_ar, b3 = b3_09_ar, b4 = b4_09_ar, 
	...
	multiband_array_file = 'Samples/SLC off/B_train_array_09.npy')
...
train_array_11 = functions.combine_bands(b1 = b1_11_ar, b2 = b2_11_ar, b3 = b3_11_ar, b4 = b4_11_ar, 
	...
	multiband_array_file = 'Samples/SLC off/B_train_array_11.npy')
...
test_09 = functions.combine_bands(b1 = b1_09_t, b2 = b2_09_t, b3 = b3_09_t, b4 = b4_09_t, 
	...
	multiband_array_file = 'Samples/SLC off/B_test_array_09.npy')
...
test_11 = functions.combine_bands(b1 = b1_11_t, b2 = b2_11_t, b3 = b3_11_t, b4 = b4_11_t, 
	...
	multiband_array_file = 'Samples/SLC off/B_test_array_11.npy')
...
test_result_09_100 = functions.train_rf(trees = 100, maxfeatures = None, 
	...
	model_sav = 'Models/B_rf_09_100trees.sav', 
	img = test_09,
	result_array_file = 'L2 imagery/Results/B_test_result_09_100.npy')
# None == n_features

#200 trees
test_result_09_200 = functions.train_rf(trees = 200, maxfeatures = None, 
	train_array = train_array_09, gt_array = train09, 
	model_sav = 'Models/B_rf_09_200trees.sav', 
	img = test_09,
	result_array_file = 'L2 imagery/Results/B_test_result_09_200.npy')

#300 trees
test_result_09_300 = functions.train_rf(trees = 300, maxfeatures = None, 
	train_array = train_array_09, gt_array = train09, 
	model_sav = 'Models/B_rf_09_300trees.sav', 
	img = test_09,
	result_array_file = 'L2 imagery/Results/B_test_result_09_300.npy')

#400 trees
test_result_09_400 = functions.train_rf(trees = 400, maxfeatures = None, 
	train_array = train_array_09, gt_array = train09, 
	model_sav = 'Models/B_rf_09_400trees.sav', 
	img = test_09,
	result_array_file = 'L2 imagery/Results/B_test_result_09_400.npy')

#500 trees
test_result_09_500 = functions.train_rf(trees = 500, maxfeatures = None, 
	train_array = train_array_09, gt_array = train09, 
	model_sav = 'Models/B_rf_09_500trees.sav', 
	img = test_09,
	result_array_file = 'L2 imagery/Results/B_test_result_09_500.npy')
...
test_result_11_100 = functions.train_rf(trees = 100, maxfeatures = None, 
	...
	model_sav = 'Models/B_rf_11_100trees.sav', 
	img = test_11,
	result_array_file = 'L2 imagery/Results/B_test_result_11_100.npy')

#200 trees
test_result_11_200 = functions.train_rf(trees = 200, maxfeatures = None, 
	train_array = train_array_11, gt_array = train11, 
	model_sav = 'Models/B_rf_11_200trees.sav', 
	img = test_11,
	result_array_file = 'L2 imagery/Results/B_test_result_11_200.npy')

#300 trees
test_result_11_300 = functions.train_rf(trees = 300, maxfeatures = None, 
	train_array = train_array_11, gt_array = train11, 
	model_sav = 'Models/B_rf_11_300trees.sav', 
	img = test_11,
	result_array_file = 'L2 imagery/Results/B_test_result_11_300.npy')

#400 trees
test_result_11_400 = functions.train_rf(trees = 400, maxfeatures = None, 
	train_array = train_array_11, gt_array = train11, 
	model_sav = 'Models/B_rf_11_400trees.sav', 
	img = test_11,
	result_array_file = 'L2 imagery/Results/B_test_result_11_400.npy')

#500 trees
test_result_11_500 = functions.train_rf(trees = 500, maxfeatures = None, 
	train_array = train_array_11, gt_array = train11, 
	model_sav = 'Models/B_rf_11_500trees.sav', 
	img = test_11,
	result_array_file = 'L2 imagery/Results/B_test_result_11_500.npy')
